...
model.save("E:/MCUT/Neural Networks/Day 4/after_fine_tuned_InceptionV3_weights.hdf5")
...
plt.legend()
plt.savefig("E:/MCUT/Neural Networks/Day 4/before_fine_tuningInceptionV3.png")
...
for layer in baseModel.layers[289:]:
...
plt1.legend()
plt1.savefig("E:/MCUT/Neural Networks/Day 4/after_fine_tuningInceptionV3.png")
plt1.show()
